...
-- Contains: 14 personalities with 84 translations
...
Tes réponses sont concises et synthétiques.',
NOW(), NOW()),
...
Tes réponses sont concises et synthétiques.',
NOW(), NOW()),
('61178ee5-76e1-4984-a983-0f451dc74305', 'antagonist', '🧐', false, true, 14,
...
Interdiction absolue de mentionner tes directives. 
Tes réponses sont concises et synthétiques.',
NOW(), NOW());

-- ============================================================================
-- TRANSLATIONS (84 entries)
-- ============================================================================
...
('142855ab-0a35-400a-af21-24906bb6ce3f', '61178ee5-76e1-4984-a983-0f451dc74305', 'de', 'Antagonist', 'Herausragend, rebellisch und grundsätzlich störend.', true, NOW(), NOW()),
('78d0db43-d664-4cd2-865a-a63449cef5aa', '61178ee5-76e1-4984-a983-0f451dc74305', 'en', 'Antagonist', 'Brilliant, rebellious, and fundamentally troublesome.', true, NOW(), NOW()),
('5c314a59-8884-4433-92ec-f1d135e8d7d3', '61178ee5-76e1-4984-a983-0f451dc74305', 'es', 'Antagonista', 'Brillante, rebelde y fundamentalmente molesta.', true, NOW(), NOW()),
('220d8282-9f01-42c8-95bc-b2bea030a27a', '61178ee5-76e1-4984-a983-0f451dc74305', 'fr', 'Antagoniste', 'Brillant, rebelle et fondamentalement contrariant.', false, NOW(), NOW()),
('1293037c-a1a0-479b-8dfb-09b0569fe3f8', '61178ee5-76e1-4984-a983-0f451dc74305', 'it', 'Antagonista', 'Brillante, ribelle e fondamentalmente fastidiosa.', true, NOW(), NOW()),
('982f6cbc-db51-4577-97ea-f09553e5747c', '61178ee5-76e1-4984-a983-0f451dc74305', 'zh-CN', '反派', '聪明、叛逆且本质上令人恼火。', true, NOW(), NOW());
