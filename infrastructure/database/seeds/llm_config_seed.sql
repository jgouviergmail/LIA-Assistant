...
VALUES
    ...
    (gen_random_uuid(), 'hitl_question_generator', 'deepseek', 'deepseek-flash', 0.3, NULL, NULL, NULL, 5000, NULL, '{"level": "none", "budget_tokens": null, "exclude_from_output": false}'::jsonb, NULL, NOW(), NOW()),
    ...
    (gen_random_uuid(), 'interest_content', 'deepseek', 'deepseek-flash', 0.3, NULL, NULL, NULL, NULL, NULL, '{"level": "none", "budget_tokens": null, "exclude_from_output": false}'::jsonb, NULL, NOW(), NOW()),
    ...
    (gen_random_uuid(), 'response', 'deepseek', 'deepseek-flash', 0.3, NULL, NULL, NULL, NULL, NULL, '{"level": "none", "budget_tokens": null, "exclude_from_output": false}'::jsonb, NULL, NOW(), NOW()),
