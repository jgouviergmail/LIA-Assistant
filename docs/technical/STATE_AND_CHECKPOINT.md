...
Le state management dans LIA repose sur **LangGraph 1.1.6** avec un schema `MessagesState` personnalise et un systeme de **PostgreSQL checkpointing** pour la persistence.
