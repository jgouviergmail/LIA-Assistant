...
L'architecture multi-agents de LIA repose sur **LangGraph 1.1.6**, un framework d'orchestration qui permet de construire des workflows d'agents complexes avec :
