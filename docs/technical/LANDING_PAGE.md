...
|-----------|---------|------|-------|-------------|
| `HeroSection` | `HeroSection.tsx` | Server (async) | `lng: string` | Section hero plein ecran avec tagline, badges Beta, CTA principal/secondaire, trust badges (16+ agents, 7 providers, 99+ voices, GDPR), chevron de scroll. Integre `HeroBackground`. |
...
| `StatsSection` | `StatsSection.tsx` | Client | aucune | 6 statistiques avec compteurs animes : 16+ agents, 50+ tools, 7 providers, 99+ voice languages, 500+ metrics, 6 UI languages. Fond `bg-primary/5`. |
