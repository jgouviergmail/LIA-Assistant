...
| Guides pratiques | 20+ |
| Runbooks | 44 |
| ADRs | 254 ADR files (ADR-255 latest — ADR-008 n'a pas de fichier séparé, d'où le numéro un cran au-dessus du décompte) |
...
| [ADR_INDEX.md](./architecture/ADR_INDEX.md) | Architecture Decision Records (254 ADR files) |
