...
| Guides pratiques | 20+ |
| Runbooks | 44 |
| ADRs | 247 ADR files (ADR-248 latest — ADR-008 n'a pas de fichier séparé, d'où le numéro un cran au-dessus du décompte) |
...
| [ADR_INDEX.md](./architecture/ADR_INDEX.md) | Architecture Decision Records (247 ADR files) |
