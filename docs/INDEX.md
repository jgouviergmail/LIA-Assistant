...
| Guides pratiques | 20+ |
| Runbooks | 45 |
| ADRs | 296 ADR files (ADR-297 latest — ADR-008 n'a pas de fichier séparé, d'où le numéro un cran au-dessus du décompte) |
...
| [ADR_INDEX.md](./architecture/ADR_INDEX.md) | Architecture Decision Records (296 ADR files) |
