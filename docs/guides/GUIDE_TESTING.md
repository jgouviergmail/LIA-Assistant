...
- **Plancher global courant** (mesuré 2026-07-20, 2 147 tests / 214 fichiers, après la clôture du chantier F010) : statements 60 / branches 54 / functions 54 / lines 60 (valeurs mesurées 60.49 / 54.86 / 54.50 / 60.94). À relever à chaque nouvelle vague de tests.
