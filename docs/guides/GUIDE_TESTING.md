...
- **Plancher global courant** (mesuré 2026-07-20, 2 175 tests / 215 fichiers, après la clôture du chantier F010) : statements 60 / branches 54 / functions 54 / lines 60 (valeurs mesurées 60.63 / 54.98 / 54.55 / 61.07). À relever à chaque nouvelle vague de tests.
