"""Reverse geocoding via OpenWeatherMap (moved from heartbeat — Lot 6).

Neutral connectors home: consumed by heartbeat, briefing AND interests;
keeping it in heartbeat created the heartbeat<->interests runtime cycle
(F009 guard). Original module docstring follows.
