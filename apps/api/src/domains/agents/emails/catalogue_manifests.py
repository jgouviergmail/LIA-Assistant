...
ADR-287: one tool, three detail levels. What the manifest publishes is what
the tool enforces (ADR-184): the default and the maximum page size, the
three levels, the paging token, the body pagination.
"""
