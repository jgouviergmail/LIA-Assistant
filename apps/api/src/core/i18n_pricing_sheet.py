...
_COLUMNS: dict[Language, dict[str, str]] = {
    "fr": {
        ...
        "is_reasoning_model": "Modèle de raisonnement",
        "reasoning_enum_values": "Profondeurs acceptées",
        ...
        "audio_input_unit_price": "Prix entrée audio (USD)",
        "audio_output_unit_price": "Prix sortie audio (USD)",
    ...
    "en": {
        ...
        "is_reasoning_model": "Reasoning model",
        "reasoning_enum_values": "Accepted depths",
        ...
        "audio_input_unit_price": "Audio input price (USD)",
        "audio_output_unit_price": "Audio output price (USD)",
    ...
    "es": {
        ...
        "is_reasoning_model": "Modelo de razonamiento",
        "reasoning_enum_values": "Profundidades aceptadas",
        ...
        "audio_input_unit_price": "Precio de entrada de audio (USD)",
        "audio_output_unit_price": "Precio de salida de audio (USD)",
    ...
    "de": {
        ...
        "is_reasoning_model": "Reasoning-Modell",
        "reasoning_enum_values": "Akzeptierte Tiefen",
        ...
        "audio_input_unit_price": "Preis für Audio-Eingabe (USD)",
        "audio_output_unit_price": "Preis für Audio-Ausgabe (USD)",
    ...
    "it": {
        ...
        "is_reasoning_model": "Modello di ragionamento",
        "reasoning_enum_values": "Profondità accettate",
        ...
        "audio_input_unit_price": "Prezzo input audio (USD)",
        "audio_output_unit_price": "Prezzo output audio (USD)",
    ...
    "zh-CN": {
        ...
        "is_reasoning_model": "推理模型",
        "reasoning_enum_values": "接受的深度",
        ...
        "audio_input_unit_price": "音频输入价格（美元）",
        "audio_output_unit_price": "音频输出价格（美元）",
