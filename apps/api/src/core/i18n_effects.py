...
EFFECT_LABELS: dict[str, dict[str, str]] = {
    "fr": {
        ...
        "effects.labels.create_reminder_tool": "Rappel « {target} » créé",
        "effects.labels.call_me_tool": "Vous a appelé au téléphone ({target})",
        "effects.labels.send_email_to_me_tool": "Vous a envoyé un e-mail ({target})",
        "effects.labels.toggle_scheduled_action_tool": "Action planifiée « {target} » activée ou suspendue",
        "effects.labels.create_ticket_tool": "Ticket « {target} » créé sur le tableau",
        "effects.labels.update_ticket_tool": "Ticket « {target} » modifié",
        "effects.labels.comment_ticket_tool": "Commentaire ajouté au ticket « {target} »",
        ...
        "effects.labels.draft.ticket_delete": "Ticket « {target} » supprimé du tableau",
    ...
    "en": {
        ...
        "effects.labels.create_reminder_tool": "Created the reminder “{target}”",
        "effects.labels.call_me_tool": "Called you on the phone ({target})",
        "effects.labels.send_email_to_me_tool": "Sent you an e-mail ({target})",
        "effects.labels.toggle_scheduled_action_tool": "Enabled or paused the scheduled action “{target}”",
        "effects.labels.create_ticket_tool": "Created the ticket “{target}” on the board",
        "effects.labels.update_ticket_tool": "Changed the ticket “{target}”",
        "effects.labels.comment_ticket_tool": "Commented on the ticket “{target}”",
        ...
        "effects.labels.draft.ticket_delete": "Deleted the ticket “{target}” from the board",
    ...
    "de": {
        ...
        "effects.labels.create_reminder_tool": "Erinnerung „{target}“ erstellt",
        "effects.labels.call_me_tool": "Hat Sie angerufen ({target})",
        "effects.labels.send_email_to_me_tool": "Hat Ihnen eine E-Mail gesendet ({target})",
        "effects.labels.toggle_scheduled_action_tool": "Geplante Aktion „{target}“ aktiviert oder pausiert",
        "effects.labels.create_ticket_tool": "Ticket „{target}“ auf dem Board erstellt",
        "effects.labels.update_ticket_tool": "Ticket „{target}“ geändert",
        "effects.labels.comment_ticket_tool": "Ticket „{target}“ kommentiert",
        ...
        "effects.labels.draft.ticket_delete": "Ticket „{target}“ vom Board gelöscht",
    ...
    "es": {
        ...
        "effects.labels.create_reminder_tool": "Recordatorio «{target}» creado",
        "effects.labels.call_me_tool": "Te ha llamado por teléfono ({target})",
        "effects.labels.send_email_to_me_tool": "Te ha enviado un correo ({target})",
        "effects.labels.toggle_scheduled_action_tool": "Acción programada «{target}» activada o pausada",
        "effects.labels.create_ticket_tool": "Ticket «{target}» creado en el tablero",
        "effects.labels.update_ticket_tool": "Ticket «{target}» modificado",
        "effects.labels.comment_ticket_tool": "Comentario añadido al ticket «{target}»",
        ...
        "effects.labels.draft.ticket_delete": "Ticket «{target}» eliminado del tablero",
    ...
    "it": {
        ...
        "effects.labels.create_reminder_tool": "Promemoria «{target}» creato",
        "effects.labels.call_me_tool": "Ti ha chiamato al telefono ({target})",
        "effects.labels.send_email_to_me_tool": "Ti ha inviato un'e-mail ({target})",
        "effects.labels.toggle_scheduled_action_tool": "Azione pianificata «{target}» attivata o sospesa",
        "effects.labels.create_ticket_tool": "Ticket «{target}» creato sulla bacheca",
        "effects.labels.update_ticket_tool": "Ticket «{target}» modificato",
        "effects.labels.comment_ticket_tool": "Commento aggiunto al ticket «{target}»",
        ...
        "effects.labels.draft.ticket_delete": "Ticket «{target}» eliminato dalla bacheca",
    ...
    "zh-CN": {
        ...
        "effects.labels.create_reminder_tool": "已创建提醒「{target}」",
        "effects.labels.call_me_tool": "已给您打电话（{target}）",
        "effects.labels.send_email_to_me_tool": "已给您发送邮件（{target}）",
        "effects.labels.toggle_scheduled_action_tool": "已启用或暂停计划操作「{target}」",
        "effects.labels.create_ticket_tool": "已在工单板上创建工单「{target}」",
        "effects.labels.update_ticket_tool": "已修改工单「{target}」",
        "effects.labels.comment_ticket_tool": "已对工单「{target}」发表评论",
        ...
        "effects.labels.draft.ticket_delete": "已从工单板删除工单「{target}」",
