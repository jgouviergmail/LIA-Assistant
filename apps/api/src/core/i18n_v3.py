"""
Internationalization (i18n) for Architecture v3 display components.

Centralized translations for the display layer: warm intro patterns,
proactive outro suggestions, formatter labels, and HTML card strings.
