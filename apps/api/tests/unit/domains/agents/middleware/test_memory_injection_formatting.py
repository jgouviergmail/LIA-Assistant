...
class TestEmotionalLabel:
    ...
    def test_the_scale_is_monotonic(self) -> None:
        ...
        ranks = [order.index(emotional_label(w)) for w in range(-10, 11)]
