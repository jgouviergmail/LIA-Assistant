...
| Tests automatisés, exécutés à chaque commit et livraison | **31 300+** |
| Décisions d'architecture documentées (ADR) | **263** |
| Versions livrées à rythme régulier | **246** |
...
Trois décisions structurantes, parmi les 263 documentées :
