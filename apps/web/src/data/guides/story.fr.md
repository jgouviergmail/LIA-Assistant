...
| Tests automatisés, exécutés à chaque commit et livraison | **29 700+** |
| Décisions d'architecture documentées (ADR) | **262** |
| Versions livrées à rythme régulier | **244** |
...
Trois décisions structurantes, parmi les 262 documentées :
