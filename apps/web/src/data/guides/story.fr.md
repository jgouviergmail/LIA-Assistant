...
| Tests automatisés, exécutés à chaque commit et livraison | **31 500+** |
| Décisions d'architecture documentées (ADR) | **265** |
| Versions livrées à rythme régulier | **248** |
...
Trois décisions structurantes, parmi les 265 documentées :
