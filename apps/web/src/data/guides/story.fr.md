...
| Tests automatisés, exécutés à chaque commit et livraison | **37 000+** |
| Décisions d'architecture documentées (ADR) | **288** |
| Versions livrées à rythme régulier | **260** |
...
Trois décisions structurantes, parmi les 288 documentées :
