...
| Tests automatisés, exécutés à chaque commit et livraison | **40 000+** |
| Décisions d'architecture documentées (ADR) | **309** |
| Versions livrées à rythme régulier | **267** |
...
Trois décisions structurantes, parmi les 309 documentées :
