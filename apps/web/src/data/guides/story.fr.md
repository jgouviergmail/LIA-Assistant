...
| Tests automatisés, exécutés à chaque commit et livraison | **26 600+** |
| Décisions d'architecture documentées (ADR) | **240** |
| Versions livrées à rythme régulier | **222** |
...
Trois décisions structurantes, parmi les 240 documentées :
