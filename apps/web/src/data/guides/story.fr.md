...
| Tests automatisés, exécutés à chaque commit et livraison | **39 000+** |
| Décisions d'architecture documentées (ADR) | **300** |
| Versions livrées à rythme régulier | **265** |
...
Trois décisions structurantes, parmi les 300 documentées :
