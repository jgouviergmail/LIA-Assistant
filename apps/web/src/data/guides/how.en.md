...
*Document written based on analysis of the source code (`apps/api/src/`, `apps/web/src/`), technical documentation (280+ documents), 93 ADRs, and the changelog (v1.0 to v1.21.7). All metrics, versions, and patterns cited are verifiable in the codebase.*
