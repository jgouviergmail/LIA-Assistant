...
*Document written based on analysis of the source code (`apps/api/src/`, `apps/web/src/`), technical documentation (280+ documents), 100+ ADRs, and the changelog (v1.0 to v1.23.6). All metrics, versions, and patterns cited are verifiable in the codebase.*
