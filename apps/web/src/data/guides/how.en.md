...
| Production reliability | 92 ADRs, ~10,000 pytest-collected tests across 484 files, native observability, 6-level HITL |
...
92 ADRs in MADR format document the major architectural decisions. Some representative examples:
...
The 92 ADRs document not only the decisions made but also the rejected alternatives and accepted trade-offs. The ~10,000 tests across 484 files, complete CI/CD, and strict MyPy are not vanity metrics — they are the mechanisms that allow evolving a system of this complexity without regression.
