...
*Document written based on analysis of the source code (`apps/api/src/`, `apps/web/src/`), technical documentation (190+ documents), 63 ADRs, and the changelog (v1.0 to v1.11.4). All metrics, versions, and patterns cited are verifiable in the codebase.*
