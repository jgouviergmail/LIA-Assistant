...
| Lines of code (excluding tests) — 36 functional domains | **495,000** |
| Automated tests, run on every commit and release | **21,000+** |
| Documented architecture decisions (ADR) | **180** |
| Versions shipped at a steady pace | **189** |
