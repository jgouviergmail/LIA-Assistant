...
| Automated tests, run on every commit and release | **31,500+** |
| Documented architecture decisions (ADR) | **265** |
| Versions shipped at a steady pace | **248** |
...
Three structural decisions, among the 265 documented:
