...
| Automated tests, run on every commit and release | **40,000+** |
| Documented architecture decisions (ADR) | **309** |
| Versions shipped at a steady pace | **267** |
...
Three structural decisions, among the 309 documented:
