...
| Affidabilità in produzione | 248 ADRs, ~20.468 test raccolti da pytest in 1.184 file, osservabilità nativa, HITL a 6 livelli |
...
| ADR (Architecture Decision Record) | 248 |
...
| Tecnologia | Ruolo |
|------------|-------|
| Prometheus | 473 metriche custom (RED pattern) |
