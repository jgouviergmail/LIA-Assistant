...
*Documento redactado sobre la base del análisis del código fuente (`apps/api/src/`, `apps/web/src/`), de la documentación técnica (190+ documentos), de los 62 ADRs y del changelog (v1.0 a v1.11.0). Todas las métricas, versiones y patrones citados son verificables en el codebase.*
