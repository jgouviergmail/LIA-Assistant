...
| Produktionszuverlässigkeit | 100+ ADRs, ~11.000 von pytest gesammelte Tests in 559 Dateien, native Observability, HITL auf 6 Ebenen |
...
| Metrik | Wert |
|----------|--------|
| Tests | ~11.000 von pytest gesammelt (von pytest über 559 Testdateien gesammelt) + 169 vitest-Tests im Frontend |
...
Die 100+ ADRs dokumentieren nicht nur die getroffenen Entscheidungen, sondern auch die verworfenen Alternativen und die akzeptierten Kompromisse. Die ~11.000 Tests in 559 Dateien, die vollständige CI/CD-Pipeline und der strikte MyPy-Modus sind keine Eitelkeitsmetriken — sie sind die Mechanismen, die es ermöglichen, ein System dieser Komplexität ohne Regressionen weiterzuentwickeln.
...
*Dokument verfasst auf Grundlage der Analyse des Quellcodes (`apps/api/src/`, `apps/web/src/`), der technischen Dokumentation (280+ Dokumente), der 100+ ADRs und des Changelogs (v1.0 bis v1.21.22). Alle genannten Metriken, Versionen und Patterns sind in der Codebase verifizierbar.*
