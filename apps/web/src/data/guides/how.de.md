...
| Produktionszuverlässigkeit | 140+ ADRs, ~15.023 von pytest gesammelte Tests in 814 Dateien, native Observability, HITL auf 6 Ebenen |
...
| Metrik | Wert |
|----------|--------|
| Tests | ~15.023 von pytest gesammelt (von pytest über 803 Testdateien gesammelt) + 2.538 vitest-Tests im Frontend (Abdeckungsschwellen fixiert, ADR-116) |
...
Die 140+ ADRs dokumentieren nicht nur die getroffenen Entscheidungen, sondern auch die verworfenen Alternativen und die akzeptierten Kompromisse. Die ~15.023 Tests in 814 Dateien, die vollständige CI/CD-Pipeline und der strikte MyPy-Modus sind keine Eitelkeitsmetriken — sie sind die Mechanismen, die es ermöglichen, ein System dieser Komplexität ohne Regressionen weiterzuentwickeln.
...
*Dokument verfasst auf Grundlage der Analyse des Quellcodes (`apps/api/src/`, `apps/web/src/`), der technischen Dokumentation (380+ Dokumente), der 140+ ADRs und des Changelogs (v1.0 bis v1.25.20). Alle genannten Metriken, Versionen und Patterns sind in der Codebase verifizierbar.*
