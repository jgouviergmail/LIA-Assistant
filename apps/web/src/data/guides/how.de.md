...
*Dokument verfasst auf Grundlage der Analyse des Quellcodes (`apps/api/src/`, `apps/web/src/`), der technischen Dokumentation (280+ Dokumente), der 91 ADRs und des Changelogs (v1.0 bis v1.21.4). Alle genannten Metriken, Versionen und Patterns sind in der Codebase verifizierbar.*
