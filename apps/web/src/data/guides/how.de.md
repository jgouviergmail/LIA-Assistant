...
| Produktionszuverlässigkeit | 70 ADRs, 2 300+ Tests, native Observability, HITL auf 6 Ebenen |
...
70 ADRs im MADR-Format dokumentieren die wichtigsten Architekturentscheidungen. Einige repräsentative Beispiele:
...
*Dokument verfasst auf Grundlage der Analyse des Quellcodes (`apps/api/src/`, `apps/web/src/`), der technischen Dokumentation (260+ Dokumente), der 70 ADRs und des Changelogs (v1.0 bis v1.18.1). Alle genannten Metriken, Versionen und Patterns sind in der Codebase verifizierbar.*
