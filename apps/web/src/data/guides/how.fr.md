...
| Fiabilité en production | 120+ ADRs, ~12 340 tests collectés par pytest sur 713 fichiers, observabilité native, HITL à 6 niveaux |
...
| Métrique | Valeur |
|----------|--------|
| Tests | ~12 340 (collectés par pytest sur 713 fichiers de test) + 2 175 tests vitest côté frontend (seuils de couverture verrouillés, ADR-116) |
...
*Document rédigé sur la base de l'analyse du code source (`apps/api/src/`, `apps/web/src/`), de la documentation technique (280+ documents), des 120+ ADRs, et du changelog (v1.0 à v1.25.11). Toutes les métriques, versions et patterns cités sont vérifiables dans le codebase.*
