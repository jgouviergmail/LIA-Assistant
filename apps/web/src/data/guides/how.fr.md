...
| Fiabilité en production | 99 ADRs, ~10 000 tests collectés par pytest sur 484 fichiers, observabilité native, HITL à 6 niveaux |
...
| openai | 1.0+ | Embeddings sémantiques | Embeddings multilingues OpenAI, optimisés pour le routage sémantique |
...
99 ADRs au format MADR documentent les décisions architecturales majeures. Quelques exemples représentatifs :
...
*Document rédigé sur la base de l'analyse du code source (`apps/api/src/`, `apps/web/src/`), de la documentation technique (280+ documents), des 99 ADRs, et du changelog (v1.0 à v1.21.13). Toutes les métriques, versions et patterns cités sont vérifiables dans le codebase.*
