...
| Fiabilité en production | 140+ ADRs, ~15 031 tests collectés par pytest sur 817 fichiers, observabilité native, HITL à 6 niveaux |
...
| Métrique | Valeur |
|----------|--------|
| Tests | ~15 031 (collectés par pytest sur 817 fichiers de test) + 2 567 tests vitest côté frontend (seuils de couverture verrouillés, ADR-116) |
...
*Document rédigé sur la base de l'analyse du code source (`apps/api/src/`, `apps/web/src/`), de la documentation technique (380+ documents), des 140+ ADRs, et du changelog (v1.0 à v1.25.21). Toutes les métriques, versions et patterns cités sont vérifiables dans le codebase.*
