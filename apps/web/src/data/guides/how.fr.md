...
| Fiabilité en production | 100+ ADRs, ~11 000 tests collectés par pytest sur 572 fichiers, observabilité native, HITL à 6 niveaux |
...
| Métrique | Valeur |
|----------|--------|
| Tests | ~11 000 (collectés par pytest sur 572 fichiers de test) + 453 tests vitest côté frontend (seuils de couverture verrouillés, ADR-116) |
...
*Document rédigé sur la base de l'analyse du code source (`apps/api/src/`, `apps/web/src/`), de la documentation technique (280+ documents), des 100+ ADRs, et du changelog (v1.0 à v1.23.6). Toutes les métriques, versions et patterns cités sont vérifiables dans le codebase.*
