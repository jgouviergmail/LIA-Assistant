...
| Fiabilité en production | 98 ADRs, ~10 000 tests collectés par pytest sur 484 fichiers, observabilité native, HITL à 6 niveaux |
...
98 ADRs au format MADR documentent les décisions architecturales majeures. Quelques exemples représentatifs :
...
*Document rédigé sur la base de l'analyse du code source (`apps/api/src/`, `apps/web/src/`), de la documentation technique (280+ documents), des 98 ADRs, et du changelog (v1.0 à v1.21.11). Toutes les métriques, versions et patterns cités sont vérifiables dans le codebase.*
