...
| Fiabilité en production | 262 ADRs, ~24 042 tests collectés par pytest sur 1 349 fichiers, observabilité native, HITL à 6 niveaux |
...
262 ADRs au format MADR documentent les décisions architecturales majeures. Quelques exemples représentatifs :
...
*Document rédigé sur la base de l'analyse du code source (`apps/api/src/`, `apps/web/src/`), de la documentation technique (490+ documents), des 262 ADRs, et du changelog (v1.0 à v1.41.0). Toutes les métriques, versions et patterns cités sont vérifiables dans le codebase.*
