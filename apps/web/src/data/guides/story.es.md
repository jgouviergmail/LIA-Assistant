...
| Líneas de código (sin tests) — 47 dominios funcionales | **655.000** |
| Tests automatizados, ejecutados en cada commit y entrega | **36.000+** |
| Decisiones de arquitectura documentadas (ADR) | **279** |
| Versiones entregadas a ritmo regular | **254** |
...
Tres decisiones estructurantes, entre las 279 documentadas:
