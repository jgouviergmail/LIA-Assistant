    ...
    <div className="p-4 bg-yellow-900/20 border border-yellow-700/50 rounded-lg">
      ...
      <div className="flex items-start gap-3 mb-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-xs text-yellow-200/90 leading-relaxed">
            The debug panel encountered an error while rendering metrics. This
            does not affect the main application functionality. Debug metrics
            may be unavailable or incomplete for this conversation turn.
          </p>
        </div>
      </div>
      ...
      <div className="mt-3 pt-3 border-t border-yellow-700/50">
        <p className="text-[10px] text-yellow-200/80 leading-relaxed">
          <strong>What to do:</strong> You can continue using the application
          normally. Debug metrics will resume on the next conversation turn. If
          this error persists, please report it to the development team with
          the technical details above.
        </p>
      </div>
    </div>
  );
