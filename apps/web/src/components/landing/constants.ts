 ...
 *   41 177 -> 41000.
 *   Re-measured 2026-09-24 (v1.47.2): backend 31 980 collected over `tests/`
 *   (sum of the per-file counts of `pytest --collect-only -q`, 1 931 files) +
 *   frontend 8 956 passing (`task test:frontend:coverage`, 714 files) =
 *   40 936 -> 40000.
 ...
 *   Re-measured 2026-09-17 (v1.45.1): backend 29 725 collected over `tests/`
 *   (sum of the per-file counts of `pytest --collect-only -q`, 1 758 files) +
 *   frontend 8 423 (`vitest list` on the HOST, 660 files) = 38 148 -> 38000.
 *   Re-measured 2026-09-16 (v1.44.7): backend 29 284 collected over `tests/`
 *   (sum of the per-file counts of `pytest --collect-only -q`, 1 722 files) +
 *   frontend 8 319 (`vitest list` on the HOST, 652 files) = 37 603 -> 37000
 *   (v1.44.6 had already shipped 37000 without a note here).
 *   Re-measured 2026-09-12 (v1.44.5): backend 28 583 collected over `tests/`
 *   (`pytest --collect-only -q`, 1 685 files) +
 *   frontend 8 314 (`vitest list` on the HOST, 651 files) = 36 897 -> 36000.
 ...
 *   v1.44.1 (2026-09-10) was 27 863 + 8 178 = 36 041 -> 36000, derived from
 *   the v1.44.0 measure plus the 573 + 161 its CHANGELOG entry counts.
 ...
 *   only moves when the rounded-down thousand does).
 *   Re-measured 2026-09-05 (v1.42.3): backend 24 263 collected over `tests/`
 *   (sum of the per-file counts of `pytest --collect-only -q`, 1 473 files) +
 *   frontend 7 397 (`vitest list` on the HOST, 586 files) = 31 660 -> 31600.
 *   Re-measured 2026-09-05 (v1.42.0): backend 24 053 collected over `tests/`
 *   (sum of the per-file counts of `pytest --collect-only -q`, 1 452 files) +
 *   frontend 7 198 (`vitest list` on the HOST, 578 files) = 31 251 -> 31000,
 *   unchanged in VALUE and now backed by the release that carries it.
 *   Re-measured 2026-09-05 (v1.41.0): backend 24 042 collected over `tests/`
 *   (sum of the per-file counts of `pytest --collect-only -q`, 1 451 files) +
 *   frontend 7 191 (`vitest list` on the HOST, 576 files) = 31 233 -> 31000.
