 ...
 *   Re-measured 2026-09-12 (v1.44.4): backend 28 500 collected over `tests/`
 *   (sum of the per-file counts of `pytest --collect-only -q`, 1 676 files) +
 *   frontend 8 299 (`vitest list` on the HOST, 649 files) = 36 799 -> 36000.
