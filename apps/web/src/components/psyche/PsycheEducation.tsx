            ...
            <div className="bg-muted/50 rounded-lg p-3 font-mono text-[10px] space-y-1">
              <div className="border border-border/50 rounded px-2 py-1 text-center">
                {t(
                  ...
                  'Layer 5 — Drives & Self-Efficacy (per session)'
                )}
              </div>
              <div className="border border-border/50 rounded px-2 py-1 text-center">
              ...
              <div className="border border-border/50 rounded px-2 py-1 text-center bg-primary/10">
                {t(
                  'psyche.education.overview.layer1',
                  'Layer 1 — Personality / Big Five (permanent)'
                )}
              </div>
            </div>
                ...
                <thead>
                  <tr className="border-b border-border/30">
                    <th className="text-left py-1 pr-2 font-medium text-foreground">
                      {t('psyche.education.traits.trait', 'Trait')}
                    </th>
                    <th className="text-left py-1 pr-2 font-medium text-foreground">
                      {t('psyche.education.traits.modulates', 'Modulates')}
                    </th>
                    <th className="text-left py-1 font-medium text-foreground">
                      {t('psyche.education.traits.effect', 'Effect')}
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-border/20">
                  <tr>
                    <td className="py-1.5 pr-2 font-medium">
                      {t('psyche.education.traits.neuroticism', 'Neuroticism')}
                    </td>
                    <td className="py-1.5 pr-2">
                      {t('psyche.education.traits.neuroticism_mod', 'Emotional reactivity')}
                    </td>
                    <td className="py-1.5">
                      {t(
                        'psyche.education.traits.neuroticism_effect',
                        'High = emotions hit harder. Low = stoic, muted reactions.'
                      )}
                    </td>
                  </tr>
                  <tr>
                    <td className="py-1.5 pr-2 font-medium">
                      {t('psyche.education.traits.agreeableness', 'Agreeableness')}
                    </td>
                    <td className="py-1.5 pr-2">
                      {t('psyche.education.traits.agreeableness_mod', 'Empathy & resilience')}
                    </td>
                    <td className="py-1.5">
                      {t(
                        'psyche.education.traits.agreeableness_effect',
                        'High = mirrors your emotions strongly. Low = resistant, pulls back to neutral when negative.'
                      )}
                    </td>
                  </tr>
                  <tr>
                    <td className="py-1.5 pr-2 font-medium">
                      {t('psyche.education.traits.conscientiousness', 'Conscientiousness')}
                    </td>
                    <td className="py-1.5 pr-2">
                      {t('psyche.education.traits.conscientiousness_mod', 'Recovery speed')}
                    </td>
                    <td className="py-1.5">
                      {t(
                        'psyche.education.traits.conscientiousness_effect',
                        'High = returns to baseline quickly. Low = moods linger.'
                      )}
                    </td>
                  </tr>
                  <tr>
                    <td className="py-1.5 pr-2 font-medium">
                      {t('psyche.education.traits.openness', 'Openness')}
                    </td>
                    <td className="py-1.5 pr-2">
                      {t('psyche.education.traits.openness_mod', 'Mood baseline')}
                    </td>
                    <td className="py-1.5">
                      {t(
                        'psyche.education.traits.openness_effect',
                        'High = curious baseline, more exploratory.'
                      )}
                    </td>
                  </tr>
                  <tr>
                    <td className="py-1.5 pr-2 font-medium">
                      {t('psyche.education.traits.extraversion', 'Extraversion')}
                    </td>
                    <td className="py-1.5 pr-2">
                      {t('psyche.education.traits.extraversion_mod', 'Mood baseline')}
                    </td>
                    <td className="py-1.5">
                      {t(
                        'psyche.education.traits.extraversion_effect',
                        'High = positive, warm baseline. Low = reserved, quieter.'
                      )}
                    </td>
                  </tr>
                </tbody>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-[10px] border-collapse">
                <thead>
                  <tr className="border-b border-border/30">
                    <th className="text-left py-1 pr-2 font-medium text-foreground">
                      {t('psyche.education.mood.col_mood', 'Mood')}
                    </th>
                    <th className="text-left py-1 pr-2 font-medium text-foreground">PAD</th>
                    <th className="text-left py-1 font-medium text-foreground">
                      {t('psyche.education.mood.col_influence', 'Behavioral influence')}
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-border/20">
            ...
            <ul className="list-disc list-inside space-y-1 text-[11px]">
              <li>
                {t(
                  ...
                  'Decay: without stimulus, mood drifts back to the personality baseline. Speed depends on Conscientiousness and the Stability setting.'
                )}
              </li>
              <li>
                {t(
                  'psyche.education.mood.emotion_push',
                  'Emotion push: each emotion has a direction in PAD space. When triggered, it pushes the mood.'
                )}
              </li>
              <li>
                {t(
                  'psyche.education.mood.contagion',
                  'Contagion: the detected emotional state of the user pulls the mood (strength depends on Agreeableness).'
                )}
              </li>
              <li>
                {t(
                  'psyche.education.mood.counter_reg',
                  'Counter-regulation: low-Agreeableness personalities resist negativity and pull back toward neutral.'
                )}
              </li>
              <li>
                {t(
                  'psyche.education.mood.circadian',
                  'Circadian: slight midday pleasure boost, midnight dip.'
                )}
              </li>
              <li>
                {t(
                  'psyche.education.mood.inertia',
                  'Inertia: the longer the mood stays in one state, the more resistant it becomes to change.'
                )}
              </li>
            </ul>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-[10px] border-collapse">
                <thead>
                  <tr className="border-b border-border/30">
                    <th className="text-left py-1 pr-2 font-medium text-foreground">
                      {t('psyche.education.emotions.col_emotion', 'Emotion')}
                    </th>
                    <th className="text-left py-1 pr-2 font-medium text-foreground">
                      {t('psyche.education.emotions.col_type', 'Type')}
                    </th>
                    <th className="text-left py-1 pr-2 font-medium text-foreground">PAD</th>
                    <th className="text-left py-1 font-medium text-foreground">
                      {t('psyche.education.emotions.col_influence', 'Behavioral influence')}
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-border/20">
                  {(
                    ...
                    <tr key={emotion}>
                      ...
                      <td
                        className={cn('py-1 pr-2 whitespace-nowrap', {
                      ...
                      <td className="py-1">
                        {t(`psyche.education.emotions.directive_${emotion}`, '')}
                      </td>
                    </tr>
                  ))}
                </tbody>
            ...
            <ul className="list-disc list-inside space-y-1 text-[11px]">
              <li>
                {t(
                  ...
                  'Cross-suppression: a positive emotion actively dampens negative ones by 30%, and vice versa. A genuine compliment reduces worry.'
                )}
              </li>
              <li>
                {t(
                  'psyche.education.emotions.blend',
                  'Blend update: emotions can increase AND decrease. A weaker repetition of the same emotion lowers its intensity (no "sticky max" effect).'
                )}
              </li>
              <li>
                {t(
                  'psyche.education.emotions.reactivity',
                  'Reactivity: Neuroticism amplifies emotion intensity (high N = very reactive, low N = stoic).'
                )}
              </li>
              <li>
                {t(
          ...
          <div className="space-y-3 text-xs text-muted-foreground leading-relaxed">
            ...
            <ul className="list-disc list-inside space-y-1 text-[11px]">
              <li>
                ...
                {t(
                  'psyche.education.relationship.orientation',
                  'Professional, measured. No assumptions of familiarity.'
                )}
              </li>
              <li>
                <strong>{t('psyche.stages.EXPLORATORY', 'Exploratory')}:</strong>{' '}
                {t(
                  'psyche.education.relationship.exploratory',
                  'Shows personality more freely. References past exchanges.'
                )}
              </li>
              <li>
                <strong>{t('psyche.stages.AFFECTIVE', 'Affective')}:</strong>{' '}
                {t(
                  'psyche.education.relationship.affective',
                  'Personal and direct. Uses humor. Remembers your preferences.'
                )}
              </li>
              <li>
                <strong>{t('psyche.stages.STABLE', 'Stable')}:</strong>{' '}
                {t(
                  'psyche.education.relationship.stable',
                  'Trusted companion. Candid, challenges constructively when needed.'
                )}
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside space-y-1 text-[11px]">
              <li>
                ...
                {t(
                  'psyche.education.relationship.depth_desc',
                  'Grows logarithmically with each quality interaction. Never decreases.'
                )}
              </li>
              <li>
                <strong>{t('psyche.warmth', 'Warmth')}:</strong>{' '}
                {t(
                  'psyche.education.relationship.warmth_desc',
                  'Active warmth that decays during absence but recovers quickly on contact.'
                )}
              </li>
              <li>
                <strong>{t('psyche.trust', 'Trust')}:</strong>{' '}
                {t(
                  'psyche.education.relationship.trust_desc',
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-[10px] border-collapse">
                <thead>
                  <tr className="border-b border-border/30">
                    <th className="text-left py-1 pr-2 font-medium text-foreground">
                      {t('psyche.education.drives.col_drive', 'Drive')}
                    </th>
                    <th className="text-left py-1 pr-2 font-medium text-foreground">
                      {t('psyche.education.drives.col_source', 'Fed by')}
                    </th>
                    <th className="text-left py-1 font-medium text-foreground">
                      {t('psyche.education.drives.col_effect', 'Effect when high')}
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-border/20">
                  <tr>
                    <td className="py-1.5 pr-2 font-medium">
                      {t('psyche.curiosityDrive', 'Curiosity')}
                    </td>
                    <td className="py-1.5 pr-2">
                      {t(
                        'psyche.education.drives.curiosity_source',
                        'Interaction energy (arousal)'
                      )}
                    </td>
                    <td className="py-1.5">
                      {t(
                        'psyche.education.drives.curiosity_effect',
                        'Explores new angles, asks follow-up questions, suggests tangents.'
                      )}
                    </td>
                  </tr>
                  <tr>
                    <td className="py-1.5 pr-2 font-medium">
                      {t('psyche.history.engagement', 'Engagement')}
                    </td>
                    <td className="py-1.5 pr-2">
                      {t('psyche.education.drives.engagement_source', 'Interaction quality')}
                    </td>
                    <td className="py-1.5">
                      {t(
                        'psyche.education.drives.engagement_effect',
                        'More thorough and proactive. In flow — takes initiative.'
                      )}
                    </td>
                  </tr>
                </tbody>
              ...
              <div className="bg-muted/50 rounded-lg p-2.5">
                ...
                <ul className="text-[10px] space-y-0.5">
                  <li>
                    0% →{' '}
                    {t(
                      'psyche.education.settings_explanation.expr_low',
                      'Stoic: emotions barely influence output'
                    )}
                  </li>
                  <li>
                    50% →{' '}
                    {t(
                      'psyche.education.settings_explanation.expr_mid',
                      'Moderate: subtle tonal shifts'
                    )}
                  </li>
                  <li>
                    100% →{' '}
                    {t(
                      'psyche.education.settings_explanation.expr_high',
                      'Highly expressive: strong emotional coloring'
                    )}
                  </li>
                </ul>
              </div>
              <div className="bg-muted/50 rounded-lg p-2.5">
                ...
                <ul className="text-[10px] space-y-0.5">
                  <li>
                    0% →{' '}
                    {t(
                      'psyche.education.settings_explanation.stab_low',
                      'Volatile: mood swings with every message'
                    )}
                  </li>
                  <li>
                    50% →{' '}
                    {t(
                      'psyche.education.settings_explanation.stab_mid',
                      'Normal: shifts over multiple messages'
                    )}
                  </li>
                  <li>
                    100% →{' '}
                    {t(
                      'psyche.education.settings_explanation.stab_high',
                      'Very stable: resistant to change'
                    )}
                  </li>
                </ul>
              </div>
