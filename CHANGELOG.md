...
- **French editorial voice unified to tutoiement** across the landing namespace (features, use cases, personas, security, CTA — the page previously mixed tu/vous within single sections); de/es/it/zh use-case descriptions rewritten from telegraphic fragments to full sentences; example 5 geography harmonized (Strasbourg everywhere, EN said Joinville-le-Pont with a Strasbourg description).
