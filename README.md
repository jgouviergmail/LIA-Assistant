...
<p align="center">
  <strong>Version 1.25.2</strong> — <strong>The landing page now speaks the product's language: a 4-act animated hero and a five-chapter editorial narrative, rebuilt with zero information loss.</strong> The hero demo becomes a <strong>faithful miniature of the real app</strong> — real layout, live token/cost bar, a request typing itself in, Send morphing into Stop — cycling through four true scenes: parallel orchestration held by the HITL approval gate, a cross-domain proactive initiative, a real agentic phone call, and a skill mini-app forged in chat; while LIA "thinks", a glass pane reveals the <strong>orchestration backstage</strong> with live token/€ counting. The 35-card features wall gives way to <strong>five chapters opened by LIA's own chat bubbles</strong> (<em>She gets it done · She knows you · She notices before you · Nothing leaves without you · She grows with you</em>), each carrying an expandable catalog that preserves every detailed card — <strong>enforced by an executable zero-loss coverage contract</strong>; commodities condense into one confident band, trust gets its own section (<em>She has nothing to hide</em>: per-message cost to the cent, the public 8.3/10 audit, open source), personas become four tabbed day-in-the-life timelines, and screenshots + deck merge into one gallery. Transcreated in 6 languages, WAI-ARIA tabs and disclosures (SEO-safe collapsed content), scroll-staged backstage vignettes, reduced-motion faithful. <strong>Verified:</strong> tsc + ESLint clean, <strong>1,303 vitest</strong> green (56 new guard tests incl. the coverage contract), a11y/react-hooks/complexity ratchets hold, strict 6-locale key parity. — 16 July 2026.
